...
#    Updated: 2024/08/13 16:00:46 by fmontser         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
NAME			:=	cub3D
HDRS			:=	cub3d.h ansi.h tests.h respath.h rad.h
SRCS			:=	main.c free.c\
					ut_math.c ut_memory.c ut_print.c ut_lists.c ut_degrees.c ut_files.c\
